...
import { Menu, Home, User, Settings, LogOut, Search, Heart, ShoppingBag, MessageCircle } from "lucide-react"
      ...
      <SheetContent side="left" className="w-80 p-0">
        ...
        <nav className="flex flex-col p-4 space-y-2">
          ...
          <div className="border-t border-gray-200 mt-4 pt-4">
            <button className="flex items-center gap-3 px-4 py-3 text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200 w-full">
